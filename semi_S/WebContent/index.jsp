                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-30">
                            ...
                            <div class="team-img">
                                <a href="${pageContext.request.contextPath}/ViewController?command=lowspec"><img src="assets/img/index/111.png" alt="" style="width:400px; height:400px;"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-30">
                            ...
                            <div class="team-img">
                                <a href="${pageContext.request.contextPath}/ViewController?command=lowspec"><img src="assets/img/index/222.png" alt="" style="width:400px; height:400px;"></a>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-30">
                            ...
                            <div class="team-img">
                                <a href="${pageContext.request.contextPath}/ViewController?command=lowspec"><img src="assets/img/index/333.png" alt="" style="width:400px; height:400px;"></a>
                            </div>
                        </div>
                    </div>
                </div>
