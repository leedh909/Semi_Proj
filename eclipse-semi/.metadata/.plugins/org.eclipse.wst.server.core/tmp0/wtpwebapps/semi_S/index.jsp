						...
						<div class="row">
							<div class="col-xl-6 col-lg-8 col-md-7 col-sm-8">
								<div class="slide-full-content">
									...
									<h1>당신은<br> 컴.잘.알?</h1>
									<p>컴퓨터 처음 조립하는 당신...</p>
									<a class="btn" href="wordcho.html">No</a>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-xl-6 col-lg-8 col-md-7 col-sm-8">
								<div class="slide-full-content">
									...
									<h1>부품별<br> 성능 추천</h1>
									<p>다양한 부분이 많아요</p>
									<a class="btn" href="#">GoGo</a>
								</div>
							</div>
						</div>
					</div>
				</div>
				<div class="slide-full d-flex slider-height align-items-center" style="background-image: url(assets/img/hero/h1_hero.png);">
					<div class="container">
						<div class="row">
							<div class="col-xl-6 col-lg-8 col-md-7 col-sm-8">
								<div class="slide-full-content">
                                    <span>#3 aritecture in united stare</span>
